...
Lista de&nbsp;Snacks
    ...
    <div class="description_box rte">
            ...
            <p>Tenemos Para ti una variedad inmensa de nuestros mejores snacks solo para ti!, Dulces, salados, acidos, Cual es tu antojo?</p>
        </div>
        <div class="hide_desc">
            <p>Bienvenido al sitio de tus snacks favoritos</p>
        </div>
        ...
        <div class="product-container" itemscope itemtype="#">
            <div class="left-block">
                <div class="product-image-container">
                    <a class="product_img_link"	href="#" title="Papitas de arroz" itemprop="url">
                        <img class="replace-2x img-responsive" src="public/img/productos/mas/arro1.jpg" alt="Papitas de arroz" title="Papitas de arroz" itemprop="image" />
                                                                                                                                  <img class="img-responsive hover-image" id="thumb-87" src="#img/p/8/7/87-tm_home_default.jpg" alt="Papitas de arroz" title="Papitas de arroz" itemprop="image" />
            ...
            <div class="right-block">
                <h5 itemprop="name">
                                                <a class="product-name" href="#" title="Papitas de arroz" itemprop="url" >
                        <span class="list-name">Papitas de arroz</span>
                        <span class="grid-name">Papitas de arroz</span>
                    </a>
                </h5>

                <p class="product-desc" itemprop="description">
                    <span class="list-desc">Te encantaria un snack saludable y bajo en carbohidratos? este es tu snack!</span>
                    <span class="grid-desc">Te encantaria un snack saludable y bajo en carbohidratos? este es tu snack!</span>
                </p>
