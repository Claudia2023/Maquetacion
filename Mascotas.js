...
Lista de&nbsp;Mascotas
    ...
    <div class="description_box rte">
            ...
            <p>Tenemos la mejor compañia para ti o para tu familia!</p>
        </div>
        <div class="hide_desc">
            <p>Con diversidad amplia para la mascota indicada para ti</p>
        </div>
        ...
        <div class="product-container" itemscope itemtype="#">
            <div class="left-block">
                <div class="product-image-container">
                    <a class="product_img_link"	href="#" title="Perro" itemprop="url">
                        <img class="replace-2x img-responsive" src="public/img/productos/mas/arro1.jpg" alt="Perro" title="Perro" itemprop="image" />
                                                                                                                                  <img class="img-responsive hover-image" id="thumb-87" src="#img/p/8/7/87-tm_home_default.jpg" alt="Perro" title="Perro" itemprop="image" />
            ...
            <div class="right-block">
                <h5 itemprop="name">
                                                <a class="product-name" href="#" title="Perro" itemprop="url" >
                        <span class="list-name">Perro</span>
                        <span class="grid-name">Perro</span>
                    </a>
                </h5>

                <p class="product-desc" itemprop="description">
                    <span class="list-desc">Perfecta mascotas para la familia!, Son activos y juguetones.</span>
                    <span class="grid-desc">Perfecta mascotas para la familia!, Son activos y juguetones.</span>
                </p>
