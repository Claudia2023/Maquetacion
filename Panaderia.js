...
Lista de&nbsp;Panaderia
    ...
    <div class="description_box rte">
            ...
            <p>Que manera de iniciar la mañana con un buen pedazo de pan y cafe, aqui tenemos tu solucion mañanera!</p>
        </div>
        <div class="hide_desc">
            <p>Todo tipo de panes con una Falta calidad de ingredientes para que lleguen a tu mesa.</p>
        </div>
        ...
        <div class="product-container" itemscope itemtype="#">
            <div class="left-block">
                <div class="product-image-container">
                    <a class="product_img_link"	href="#" title="Pan flauta" itemprop="url">
                        <img class="replace-2x img-responsive" src="public/img/productos/mas/arro1.jpg" alt="Pan flauta" title="Pan flauta" itemprop="image" />
                                                                                                                                  <img class="img-responsive hover-image" id="thumb-87" src="#img/p/8/7/87-tm_home_default.jpg" alt="Pan flauta" title="Pan flauta" itemprop="image" />
            ...
            <div class="right-block">
                <h5 itemprop="name">
                                                <a class="product-name" href="#" title="Pan flauta" itemprop="url" >
                        <span class="list-name">Pan flauta</span>
                        <span class="grid-name">Pan flauta</span>
                    </a>
                </h5>

                <p class="product-desc" itemprop="description">
                    <span class="list-desc">Buen pan con excelente sabor para comer con embutidos.</span>
                    <span class="grid-desc">Buen pan con excelente sabor para comer con embutidos.</span>
                </p>
